        ...
        <v-list dense nav>
            <v-list-item>
                <v-list-item-avatar class="align-self-center">
                    <v-img src="OIP-C.jpg" contain />
                </v-list-item-avatar>
                <v-list-item-content>
                    <v-list-item-title class="display-1 font-weight-light">{{ profile.title }}</v-list-item-title>
                </v-list-item-content>
            </v-list-item>
        </v-list>
...
export default {
                ...
                children: [
                    {
                        ...
                        to: '/pages/leave_examination'
                    },
                    {
                        title: '审批意见列表',
                        icon: 'mdi-clipboard-text-search-outline',
                        to: '/pages/approval_list'
                    }
                ]
            },
            {
    ...
    computed: {
        ...
        profile() {
            return {
                avatar: true,
                title: this.$store.state.emp_name,
            }
        },
    },
