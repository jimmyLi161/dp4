...
import com.example.demo.data.user.UserVo;
...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    public Employee addEmployeeInfo(Employee employee) {
        ...
        User userInfo = new UserVo();
        userInfo.setAuth(employeeInfo.getAuth());
        userInfo.setId(employeeInfo.getEmpID());
        userInfo.setName(employeeInfo.getEmpName());
        int type = -1;
        if (employeeInfo.getEmpID() == 3) {
            type = -2;
        }
    ...
    public void BOUpdate(Employee employeeBO, Employee employeeVO){
        ...
        if(employeeVO.getGender() != null){
            employeeBO.setGender((employeeVO.getGender()));
        }
    }
